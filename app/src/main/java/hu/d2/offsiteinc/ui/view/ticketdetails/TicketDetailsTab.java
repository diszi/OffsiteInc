...
import hu.d2.offsiteinc.BuildConfig;
...
import hu.d2.offsiteinc.ui.view.component.AssetDetailsDialog;

import hu.d2.offsiteinc.ui.view.component.ChooseOwnerDialog;
import hu.d2.offsiteinc.ui.view.component.ChooseOwnerGroupDialog;
import hu.d2.offsiteinc.ui.view.component.ChoosePriorityDialog;
import hu.d2.offsiteinc.ui.view.component.ChooseStatusDialog;
import hu.d2.offsiteinc.ui.view.component.SavePictureDialog;
...
public class TicketDetailsTab extends Fragment {
    ...
    private void loadTicketDetails(IncidentEntity entity) {
    ...
    * */
    ...
    /*
    *   OnClick on zoom icom - display asset details in alert dialog or error message (msg: no assigned asset)
    * */

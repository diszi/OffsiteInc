...
import hu.d2.offsiteinc.ui.view.ticketlist.TicketListPresenter;
import hu.d2.offsiteinc.ui.view.ticketlist.TicketListPresenterImpl;
import hu.d2.offsiteinc.util.EnvironmentTool;
import hu.d2.offsiteinc.util.FileUtils;
...
public class TicketDetailsActivity extends AppCompatActivity implements TicketDetails {
	...
	private void addTabFragmentsToViewPager(ViewPager viewPager) {
		...
		bundle.putSerializable(IncidentEntity.SERIALIZABLE_NAME, ticket);
	 ...
	 */
	@Override
	public void loadTicketDetails(IncidentEntity entity) {

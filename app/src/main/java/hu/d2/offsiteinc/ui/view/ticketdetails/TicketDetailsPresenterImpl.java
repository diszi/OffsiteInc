...
import hu.d2.offsiteinc.remote.AddFileSOAP;
import hu.d2.offsiteinc.remote.AddWorkLogSOAP;
import hu.d2.offsiteinc.remote.GetAttachmentsSOAP;
import hu.d2.offsiteinc.remote.GetFileSOAP;
import hu.d2.offsiteinc.remote.GetWorkLogSOAP;
import hu.d2.offsiteinc.remote.UpdateOwnerGroupSOAP;
import hu.d2.offsiteinc.remote.UpdateOwnerSOAP;
import hu.d2.offsiteinc.remote.UpdatePrioritySOAP;
import hu.d2.offsiteinc.remote.UpdateStatusSOAP;

import hu.d2.offsiteinc.remote.UpdateTaskStatusSOAP;
import hu.d2.offsiteinc.ui.model.Attachment;
import hu.d2.offsiteinc.ui.model.DocLinks;
...
//                Thread.sleep(2000);
                ...
                InputStream inputStream = null;
                try {
                    connection = NetworkTool.createSOAPConnection(NetworkTool.SOAP_INC_URL_UPDATE, UpdateStatusSOAP.SOAP_ACTION,String.format(UpdateStatusSOAP.getSoapPayload(ticketID,status),view.getLoggedInUser()));
...
//                Thread.sleep(2000);
                ...
                InputStream inputStream = null;
                try {
                    connection = NetworkTool.createSOAPConnection(NetworkTool.SOAP_INC_URL_UPDATE, UpdateTaskStatusSOAP.SOAP_ACTION,String.format(UpdateTaskStatusSOAP.getSoapPayload(ticketID,status, wonum,  siteID)));
...
//                Thread.sleep(2000);
                ...
                InputStream inputStream = null;
                try {
                    connection = NetworkTool.createSOAPConnection(NetworkTool.SOAP_INC_URL_UPDATE, UpdateOwnerGroupSOAP.SOAP_ACTION,String.format(UpdateOwnerGroupSOAP.getSoapPayload(ticketID,ownerGroup),view.getLoggedInUser()));
...
//                Thread.sleep(2000);
                ...
                InputStream inputStream = null;
                try {
                    connection = NetworkTool.createSOAPConnection(NetworkTool.SOAP_INC_URL_UPDATE, UpdateOwnerSOAP.SOAP_ACTION,String.format(UpdateOwnerSOAP.getSoapPayload(ticketID,owner),view.getLoggedInUser()));
...
//                Thread.sleep(2000);
                ...
                InputStream inputStream = null;
                try {
                    connection = NetworkTool.createSOAPConnection(NetworkTool.SOAP_INC_URL_UPDATE, UpdatePrioritySOAP.SOAP_ACTION,String.format(UpdatePrioritySOAP.getSoapPayload(ticketID,priority),view.getLoggedInUser()));
...
//                Thread.sleep(2000);
                ...
                try {
                    ...
                    connection = NetworkTool.createSOAPConnection(NetworkTool.SOAP_INC_URL_UPDATE, UpdateOwnerSOAP.SOAP_ACTION,String.format(AddWorkLogSOAP.getSoapPayload(ticketID,owner,shortDesc,longDesc),view.getLoggedInUser()));
                    int responseCode = connection.getResponseCode();
                    if (responseCode == 200) {
                        inputStream = connection.getInputStream();
...
//                Thread.sleep(2000);
                ...
                InputStream inputStream = null;
                try {
                    connection = NetworkTool.createSOAPConnection(NetworkTool.SOAP_INC_URL_UPDATE,UpdateOwnerSOAP.SOAP_ACTION,String.format(AddFileSOAP.getSoapPayload(ticketID,generatedName, fileNameWithExtension, encode, urlname),view.getLoggedInUser()));

...
import hu.d2.offsiteinc.app.info.AboutAppActivity;
import hu.d2.offsiteinc.app.singleton.SettingsSingleton;
import hu.d2.offsiteinc.app.singleton.TimerSingleton;
...
import hu.d2.offsiteinc.ui.view.component.ChooseStatusDialog;
import hu.d2.offsiteinc.ui.view.component.OnBackPressedDialog;
...
import hu.d2.offsiteinc.ui.view.settings.SettingsActivity;
import hu.d2.offsiteinc.ui.view.ticketdetails.TicketDetailsActivity;
import hu.d2.offsiteinc.ui.view.verifications.UpdateActivity;
import hu.d2.offsiteinc.ui.view.verifications.UpdateApp;
import hu.d2.offsiteinc.ui.view.verifications.VerificationPresenter;
import hu.d2.offsiteinc.ui.view.verifications.VerificationPresenterImpl;
...
public class TicketListActivity extends AppCompatActivity implements  TicketList,UpdateApp{
    ...
    private List<IncidentEntity> ticketList;
    ...
    protected void onResume() {
        ...
        if (this.ticketList!=null && this.ticketList.size() != 0){
            IncidentEntity ticket = this.ticketList.get(0);
        }
     ...
     */
    @Override
    public void loadList(List<IncidentEntity> ticketList){

...
import hu.d2.offsiteinc.app.OffsiteIncApplication;
...
public class EnvironmentTool {
    ...
    public static String getAppSize(){
        File f = new File(OffsiteIncApplication.getAppContext().getApplicationInfo().publicSourceDir);
    ...
    public static String getAppPackageName(){
        return  OffsiteIncApplication.getAppContext().getPackageName();
    }

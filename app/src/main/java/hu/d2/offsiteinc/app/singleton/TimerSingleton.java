package hu.d2.offsiteinc.app.singleton;
...
public class TimerSingleton {
     ...
     *  TimerTask object created -> schedules the specified task for execution
     *  after the specified delay (delay = timeout value)
     */

...
public class GetFileSOAP {
    ...
    public static String getSoapPayload(String tickedID){
        ...
        return "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:max=\"http://www.ibm.com/maximo\">\n"+
                "   <soapenv:Header/>\n"+
                "   <soapenv:Body>\n"+
                "      <max:QueryMOB_DOC2_INC creationDateTime=\"\" baseLanguage=\"\" transLanguage=\"\" messageID=\"\" maximoVersion=\"\"  uniqueResult=\"0\" rsStart=\"0\">\n"+
                "         <max:MOB_DOC2_INCQuery orderby=\"\" operandMode=\"AND\">\n"+
                "            <!--Optional:-->\n"+
                ...
                "           \n"+
                "            </max:INCIDENT>\n"+
                "         </max:MOB_DOC2_INCQuery>\n"+
                "      </max:QueryMOB_DOC2_INC>\n"+
                "   </soapenv:Body>\n"+
                "</soapenv:Envelope>";
    }
